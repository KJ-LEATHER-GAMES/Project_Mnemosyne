...
| ATS-D-016   | Ver1.1改善案では「今日の未報告一覧」と「夜まとめ報告」をP0候補とする               | その都度報告する運用は子どもにとって負荷が高く、報告忘れが発生しやすいため            | version-planning / ux       | none        | `docs/projects/ats/memory/current-status.md`  | active | 2026-06-05   | 2026-06-05 | none         |
...
| ATS-CON-008   | Ver1.1案は正式仕様化されるまで、実装済み機能として扱わない                     | version-planning      | `ATS-D-016`           | `docs/projects/ats/memory/active-decisions.md` | active | 2026-06-05 |

...
| ATS-RISK-009 | Candidate Sourcesを実在文書として扱う | Confirmed Sourcesにない文書は存在確認後に使う |
...
| Review Agent | active-decisions / confirmed implementation docs | usecase-contracts / database-design / test-results | 設計レビュー結果 |
...
| 1.0.0 | 2026-06-05 | active | P1修正としてConfirmed SourcesとCandidate Sourcesを分離し、存在未確認docsを誤認しないルールを追加してActive化。 | こうちゃん |

...
|---|---|---|---|---|---|---|---|---|---|
| ATS-TASK-004 | P0 | Ver1.1登録支援案を正式な改善候補として整理する | 子どもの報告忘れ・親の代理登録負荷を下げる次期改善を明確化する | Ver1.1案、運用観察メモ | Ver1.1改善候補リストまたは仕様ドラフト | P0候補、P1候補、P2候補が分離され、未決定事項がDecision扱いされていない | todo | `docs/projects/ats/memory/next-actions.md` | ATS-ISS-001 / ATS-ISS-002 / ATS-PD-005 |
...
| Task ID | Priority | Task | Completion Result | Completed At | Source Path |
|---|---|---|---|---|---|
| ATS-TASK-001 | P0 | ATS memory 5文書をActive化する | P0/P1修正を反映し、ATS memory 5文書をActive化した | 2026-06-05 | `docs/projects/ats/memory/next-actions.md` |
| ATS-TASK-002 | P0 | ATSテンプレート適用検証レビューをActive化する | M1-5の検証レビュー文書をActive化し、判定をGoへ更新した | 2026-06-05 | `docs/projects/ats/memory/next-actions.md` |
| ATS-TASK-003 | P0 | `current-status.md` のTask記載を正本参照形式へ整理する | `current-status.md` のIn ProgressをTask ID参照中心へ変更し、Task詳細を `next-actions.md` に集約した | 2026-06-05 | `docs/projects/ats/memory/next-actions.md` |
...
| 1.0.0 | 2026-06-05 | active | P0修正としてM1-5作成系Taskを完了扱いにし、Task正本を本書へ集約した状態でActive化。 | こうちゃん |

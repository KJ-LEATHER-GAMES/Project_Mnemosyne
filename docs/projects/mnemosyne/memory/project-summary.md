...
GitHub docs、ADR、Notion、PostgreSQL、Context Pack、RAG、MCP、Agentなどを段階的に組み合わせ、AIが参照できる記憶基盤を構築することを目的とする。
...
| AI参照入口                      | `docs/projects/mnemosyne/memory/ai-entrypoint.md`             | 参照ルートの正本                |
